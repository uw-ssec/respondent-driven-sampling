module.exports = {
    ...
    // Used for authToken
    err_account_not_found: "User account not found. Please contact your admin.",
    err_unapproved_account: "User account not approved yet. Please contact your admin.",
    // Used in signup
    err_user_exist_login: "User already exists – please log in.",
     // Used in preapprove
    err_user_exist_phone: "User already exists with this phone",
    err_user_not_exist: "User not found.",
    // Used in login
    err_phone_not_found: "No account for this phone – please sign up.",
    err_invalid_otp: "Invalid OTP",
    err_survey_not_found: "Survey not found",
