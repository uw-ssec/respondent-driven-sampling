...
const sleepingSituationChoices = [
    {'value': 'outside_in_tent', 'text': 'Outside in a tent (or tent-like structure)'},
    {'value': 'outside_no_tent', 'text': 'Outside, not in a tent'},
    {'value': 'small_vehicle', 'text': 'In a car, truck, or van (smaller vehicle)'},
    {'value': 'large_vehicle', 'text': 'In an RV, trailer, or bus/boat (larger vehicle)'},
    {'value': 'park', 'text': 'In a park (uncovered, like on a bench)'},
    {'value': 'shelter', 'text': 'In an overnight shelter (e.g. mission, church, resource shelter, etc.)'},
    {'value': 'hotel', 'text': 'In a hotel or motel'},
    {'value': 'abandoned_building', 'text': 'In an abandoned building/backyard or storage structure'},
    {'value': 'public_facility', 'text': 'In a public facility or transit (bus/train station, transit center, airport, hopsital waiting room)'},
    {'value': 'tiny_home', 'text': 'In a tiny home'},
    {'value': 'public_transit', 'text': 'On public transit (e.g. slept on bus, train, etc.)'},
    {'value': 'jail', 'text': 'In jail or prison'},
    {'value': 'hospital', 'text': 'In a hopsital (stayed as a patient overnight)'},
    {'value': 'drug_alcohol_treatment', 'text': 'In a drug or alcohol treatment/detox center'},
    {'value': 'friend_family', 'text': 'In a friend or family member\'s house/apartment'},
...
const personalLivingSituationPage =
    {
        ...
        elements: [
            ...
            },
            {
                ...
                isRequired: true,
                visibleIf: "{sleeping_situation} = 'small_vehicle' or {sleeping_situation} = 'large_vehicle'"
            },
            {
                type: 'dropdown',
